...
MediaTek MT8173 Chromebook, PowerVR (no mainline GPU driver). **Definition only** - not built or verified here.
...
kernel quirks staged in `sdk/board/chromebook-mt8173/patches/`.
