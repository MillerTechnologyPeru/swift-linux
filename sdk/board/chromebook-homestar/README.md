# Lenovo Duet 5 Chromebook (homestar)

Qualcomm SC7180 Chromebook, Adreno 618 (freedreno). **Definition only** - not built or verified here.
...
kernel quirks staged in `sdk/board/chromebook-sc7180/patches/`.
